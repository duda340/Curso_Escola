        ...
        public List<Curso> List()
        {
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    curso.Nome_Curso = DAO.GetString(reader, "nome_cur");
                    curso.Descricao = DAO.GetString(reader, "descricao_cur");
                    curso.CargaH = DAO.GetString(reader, "carga_horaria_cur");
                    curso.Turno = DAO.GetString(reader, "turno_cur");
